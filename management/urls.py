...
urlpatterns = [
    ...
    path('features/',views.showfeatures,name='features'),
    path('adddiscountproduct/',views.adddiscountproduct,name='adddiscountproduct'),
    path('addnewproduct/',views.adddiscountproduct,name='addnewproduct'),
